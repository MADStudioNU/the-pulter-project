          ...
          <footer id="footer" class="lato">
            <div class="footer-box">
              <div class="footer">
                ...
                <h6>Get in touch</h6>
                <h6>Downloads</h6>
                <h6><a href="#" onclick="PP.resetState(); return false;">Reset App State</a></h6>
              </nav>
              </div>
            </div>
          </footer>
