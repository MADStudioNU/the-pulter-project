...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="pulterManuscriptIcon">/images/page-mock.svg</xsl:variable>
  ...
  <!-- Poem index: display or not initially -->
  <xsl:variable name="displayPoemIndex">true</xsl:variable>
  ...
  <xsl:variable name="projectConventionsHref">/about-project-conventions.html</xsl:variable>
